package com.mcquilleninteractive.learnhvac.model
{
	...
	{			
		...
		public function init():void
		{
			...
			runsArr = []
			runsArr[LongTermSimulationDataModel.RUN_1] = new EnergyPlusData(scenarioModel)
			runsArr[LongTermSimulationDataModel.RUN_2] = new EnergyPlusData(scenarioModel)						
		}
		...
		*/		
		...
		{			
			...
			if (runsArr[runID]==undefined)
			{
				...
				runsArr[runID] = new EnergyPlusData(scenarioModel)
			}
